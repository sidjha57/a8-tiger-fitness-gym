  ...
  return (
    <div
      onMouseEnter={() => {
        ...
        document
          .getElementById("service-" + idNum + "-box")
          .classList.add("top-[0px]", "bg-yellow-600/90");
        document
          .getElementById("service-" + idNum + "-title")
          .classList.add("top-10");
        document
          .getElementById("service-" + idNum + "-icon")
          .classList.add("top-6", "text-yellow-600", "child:bg-white");
      }}
      onMouseLeave={() => {
        //Remove Classes
        document
          .getElementById("service-" + idNum + "-box")
          .classList.remove("top-[0px]", "bg-yellow-600/90");
        document
          .getElementById("service-" + idNum + "-title")
          .classList.remove("top-10");
        document
          .getElementById("service-" + idNum + "-icon")
          .classList.remove("top-6", "text-yellow-600", "child:bg-white"); //Add Classes
