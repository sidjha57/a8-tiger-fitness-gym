    ...
    <div className=" flex justify-center gap-10 text-gray-black flex-wrap mt-24">
      <div className="w-[300px] h-[400px] flex flex-col items-center justify-end">
        <div className="h-[300px] w-[300px] relative">
          <Image
            className="object-contain drop-shadow-2xl shadow-yellow-500 z-40 absolute sm:grayscale"
            alt={`Trainer ${name}`}
            src={img}
            fill
            id={`${nameID}-img`}
          ...
          />
          <Image
            className="object-fit shadow-yellow-500 z-10 bottom-0 absolute"
        ...
        <button
          ...
          onMouseEnter={() => {
            document.getElementById(`${nameID}-box-yellow-bar`).classList.add("w-full");
            document
              .getElementById(`${nameID}-box-yellow-bar`)
              .classList.remove("w-1/4");
          }}
          onMouseLeave={() => {
            document.getElementById(`${nameID}-box-yellow-bar`).classList.add("w-1/4");
            document
              .getElementById(`${nameID}-box-yellow-bar`)
        ...
        >
          ...
          <div className="flex justify-center items-end relative bottom-0 h-3">
            <div
              ...
              className="h-[4px] w-1/4 bg-yellow-500 relative bottom-0 transition-all duration-500"
            ></div>
          </div>
        </button>
      </div>
